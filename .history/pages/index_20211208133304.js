    ...
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <header className="flex w-full p-5 justify-between text-sm text-gray-700">
        ...
        <div className="flex space-x-4 items-center">
          ...
          <Avatar url={"https://avatars.githubusercontent.com/u/80130423?s=400&u=ee890a13659a496bd19eaca8d230805c164c5fdd&v=4"} />
        </div>
      </header>

      {/* Body */}
      <form className="flex flex-grow items-center mt-44 flex-col w-4/5">
        <Imagehttps://www.google.co.uk/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png
          src=""
          height={100}
          width={300}
          alt=""
